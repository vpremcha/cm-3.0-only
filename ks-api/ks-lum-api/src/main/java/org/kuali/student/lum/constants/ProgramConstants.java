package org.kuali.student.lum.constants;

import java.util.Arrays;
import java.util.List;

/**
 * This class came from ks-lum/ks-lum-program. A few of the constants are used in the
 * KRMS UI code and in the course controller.
 */
